...
- **Word 报告自动生成**：流水线末尾自动生成公文排版格式的 Word 分析报告（需 python-docx）
...
| `IP_IP_DOMAIN_LOOKUP_PROJECT_NAME` | 否 | `temp` | ip_domain_lookup 场景项目名称 |
| `IP_TRACE_IP_PROJECT_NAME` | 否 | `temp` | trace_ip 场景项目名称 |
...
| Phase 5 | 生成 Word 报告 | `{project_name}.trace_report.docx` |
